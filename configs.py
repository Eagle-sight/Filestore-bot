...
STREAM_LOGS = environ.get('STREAM_LOGS','-1002185431065')
...
class Config(object):
	...
	BOT_TOKEN = os.environ.get("BOT_TOKEN","7496787769:AAGTP8EzEOr-DxUrNR_SBSyb9JeeV4MGwz0")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "FilestoreContributerBot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL",-1002229781799))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "7126250699"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://filestore:filestore@cluster0.oeaevfk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002190183959")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002185431065")
	...
	LAZY_PIC = os.environ.get("LAZY_PIC","https://graph.org/file/06565c0cdbea661a2f51a.jpg")
